...
const AdminLayout: React.FC = () => {
  ...
  const navLinks = [
    ...
    { to: '/admin/ads', icon: 'campaign', label: 'Ads & Promos' },
    { to: '/admin/homepage', icon: 'web', label: 'Homepage' },
    ...
    <div className="bg-background text-on-background flex h-screen w-screen overflow-hidden">
      ...
      >
        <div className="px-8 mb-10 text-center relative">
          <h1 className="font-headline text-2xl font-bold text-primary tracking-tight">SUGA Admin</h1>
          <p className="font-body text-xs text-on-surface-variant uppercase tracking-widest mt-1">Platform Control</p>
          <button
            onClick={() => setIsMobileOpen(false)}
      ...
      <div className="lg:pl-64 flex-1 flex flex-col h-screen relative w-full overflow-hidden">
        ...
        <header className="bg-surface h-16 border-b border-outline-variant/10 flex justify-between items-center px-6 lg:px-8 z-40 w-full shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="font-headline text-lg lg:text-xl font-semibold text-on-surface">SUGA Control Panel</div>
          </div>
          
          <div className="flex items-center gap-4">
            <span className="hidden sm:inline font-body text-xs text-on-surface-variant font-medium">
